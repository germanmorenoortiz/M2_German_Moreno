...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(aplicationIoT.toString());
		
		// CREAMOS UN OBJETO DE AppMobile
		
		String[] permisos = { "Teléfono", "Almacenamiento/Memoria", "Mensajes de texto/SMS", "Calendario", "Cámara",
				"Contactos", "Ubicación", "Micrófono", "Sensores Corporales" };
		...
		System.out.println(aplicationMobile.toString());
	   ...
	   /** Framework Backend => .NET core[Microsoft], Laravel[Php], Express[Node],
		   Spring[Java], Spring Boot[Java], DJango[Python]
		   String nameFrameworkBack, String nameFrameworkFront, String
		   lenguajeProgramacion, boolean persistencia, float complejidad, long
		   lineasCodigo,
		   int casosTest
		**/
		AppWeb aplicationWeb = appWeb.createApp("Spring Boot", "React", "Java", true, 60, 300, 100);
		
		System.out.println(aplicationWeb.toString());
	}
}
