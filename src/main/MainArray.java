...
public class MainArray {
	...
	static int entrada;
	static AppWeb[] aplicacionesWeb = new AppWeb[2];
	static AppIoT[] aplicacionesIoT = new AppIoT[2];
	static AppMobile[] aplicacionesMobile = new AppMobile[2];
	...
	private static void datosAppWeb() {
		...
		// String nameFrameworkBack, String nameFrameworkFront,
		...
		while (numApp <= 2) {
			...
			aplicacionesWeb[numApp-1] = aplicationWeb;
	...
	public static void datosAppIoT() {
		...
		while (numApp <= 2) {
			...
			aplicacionesIoT[numApp-1] = aplicationIoT;
...
//			}
			...
			aplicacionesMobile[numApp-1] = aplicationMobile;
